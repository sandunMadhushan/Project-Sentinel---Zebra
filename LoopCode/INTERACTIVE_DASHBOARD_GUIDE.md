...
2. Choose your input method:
   - **Select from presets**: Choose from detected data folders
   - **Enter custom path**: Type your own folder path

### Step 3: Select Data Folder
**Preset Options (Auto-detected):**
...
**Custom Path Example:**
```
E:/Other Projects/other-clones/Project-Sentinel---Zebra/tools/generated_test_data
```
